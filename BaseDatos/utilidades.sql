...
INSERT INTO woaho.profesional
(profesional_id, profesional_nombre, profesional_apellido, profesional_profesiones, profesional_nacionalidad, profesional_servicios, profesional_lenguajes, profesional_descripcion, profesional_imagen_icono, profesional_cant_estrellas, profesional_cant_servicios)
VALUES(8, 'Armando', 'Renteria', '1-2-3', 1,     '2-3'    , '1-2', 'Experto en mecanica general y desarrollo de software', 28, 0, 0);
...
INSERT INTO woaho.servicio (servicio_id, servicio_nombre, servicio_imagen, servicio_categoria, servicio_territorio,servicio_descripcion)
							VALUES(7, 'Jardineria', 10, 5, 1,'Servicio para el cuidado del jardin');
							 
INSERT INTO woaho.tarifa (tarifa_valor,tarifa_moneda,tarifa_territorio,tarifa_servicio,tarifa_unidad)
							 VALUES (45000,1,1,7,1);
...
INSERT INTO woaho.usuario(usuario_nombre,usuario_apellido,usuario_celular,usuario_correo,usuario_acepta_terminos,usuario_fecha_hora_acepta_terminos,usuario_clave)
VALUES('dayana','mu�oz','3147452428','dayana_98@gmail.com','S',CURRENT_TIMESTAMP,'5678');
...
INSERT INTO woaho.calificacion (calificacion_usuario,calificacion_profesional,calificacion_descripcion,calificacion_calificacion,calificacion_servicio)
					 VALUES (1,1,'Muy buen servicio',4,3);
					 
INSERT INTO woaho.calificacion (calificacion_usuario,calificacion_profesional,calificacion_descripcion,calificacion_calificacion,calificacion_servicio)
					 VALUES (2,1,'servicio regular',3,3);
